-module(user_management_worker_sup).
...
worker_count(Count) ->
    service_worker_sup:worker_count(?MODULE, user_management, user_management_worker, Count).
...
init(no_arg) ->
    ...
    Workers = service_worker_sup:create_childspec(
                user_management, user_management_workers, user_management_worker),
